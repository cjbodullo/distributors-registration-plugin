...
class DREG_Distributor_Registration_Controller
{
    /**
    ...
    {
        $tables = DREG_Model_Distributor_Tables::resolve();
        ...
        $repo = new DREG_Distributor_Repository($tables);
        ...
        $plan = DREG_Distributor_Repository::compute_plan_months($sampleFrequency, $nuOfSamples);
        if (empty($plan['valid'])) {
